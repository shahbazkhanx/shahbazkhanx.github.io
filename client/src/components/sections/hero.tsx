    ...
    >
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          >
            Building SEO-first, conversion-optimized websites with clean,
            scalable code.
          </motion.p>
          ...
          >
            <button
              ...
              className="group relative px-8 py-4 glass-card-hover text-white font-medium rounded-2xl"
            ...
            <button
              ...
              className="px-8 py-4 text-slate-300 hover:text-blue-400 font-medium transition-colors duration-300 flex items-center rounded-2xl"
